...
![home page wireframe](./wireframe_home-page.png)
...
![login page wireframe](./wireframe_login-page.png)
...
![user profile page wireframe](./wireframe_user-profile-page.png)
...
![join table page wireframe](./wireframe_join-table-page.png)
...
![create table page wireframe](./wireframe_create-table-page.png)
...
![game table page wireframe](./wireframe_table-page.png)
